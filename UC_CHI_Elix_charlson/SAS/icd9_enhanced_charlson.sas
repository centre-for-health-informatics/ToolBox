...
/*The program is to define Charlson comorbidities based on enhanced ICD-9-CM diagnosis codes */
...
libname comorbid 'D:\data\icd9';	/********A:change to your own library*/
...
data &lib_out..&data_out;
	...
	%do DI=1 %to 17;		/*ICD9-E Charlson: 17 groups*/
		...
		DROP A1;	
	%end;
	Charlson_index=sum(of ICD9_E_CH_MI--ICD9_E_CH_DIAB_UC)*1+sum(of ICD9_E_CH_DIAB_C--ICD9_E_CH_CANCER)*2+ICD9_E_CH_MSLD*3+ICD9_E_CH_METS*6+ICD9_E_CH_HIV*6;/*Calculating Charlson index*/
...
%ICD9_E_CH(lib_in=comorbid, lib_out=comorbid, data_in=icd9CM3, data_out=ICD9_E_CH);	 /********C: change the libraies and data*/
