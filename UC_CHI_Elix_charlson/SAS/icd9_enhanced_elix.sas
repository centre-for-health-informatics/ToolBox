...
/*The program is to define Elixhauser comorbidities based on enhanced ICD-9-CM diagnosis codes */
...
%ICD9_E_EX(lib_in=comorbid, lib_out=comorbid, data_in=icd9CM3, data_out=ICD9_E_EX);	 /********C: change the libraies and data*/
